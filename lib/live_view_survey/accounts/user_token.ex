defmodule LiveViewSurvey.Accounts.UserToken do
  ...
  schema "users_tokens" do
    ...
    belongs_to :user, LiveViewSurvey.Accounts.User
  ...
  defp build_hashed_token(user, context, sent_to) do
    ...
    {Base.url_encode64(token, padding: false),
     %LiveViewSurvey.Accounts.UserToken{
       token: hashed_token,
       context: context,
       sent_to: sent_to,
       user_id: user.id
  ...
  def token_and_context_query(token, context) do
    from LiveViewSurvey.Accounts.UserToken, where: [token: ^token, context: ^context]
  end
  ...
  def user_and_contexts_query(user, :all) do
    from t in LiveViewSurvey.Accounts.UserToken, where: t.user_id == ^user.id
  end
